        ...
        <script type="text/javascript">
		  ...
		  <div class="form-group">
			  ...
			  <select id="age" name="age">
				  <option value=0>17&ndash;21</option>
				  <option value=1>22&ndash;26</option>
				  <option value=2 selected>27&ndash;31</option>
				  <option value=3>32&ndash;36</option>
				  <option value=4>37&ndash;41</option>
				  <option value=5>42&ndash;46</option>
			  </select>
		  </div>
		  <div class="form-group">
			  <label for="gender">Gender</label>
			  <select id="gender" name="gender"><option value="male" selected>Male</option><option value="female">Female</option></select>
		  </div>
